...
import { attachLayerInfo } from "./map/layer-info";
...
const plugin: GeoLibrePlugin = {
  ...
  activate(app) {
    ...
    // What each corroboration layer switched on holds under the cursor, on a
    // pause or a right click.
    teardown.push(attachLayerInfo(app));
