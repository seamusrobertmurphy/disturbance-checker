...
[![Canopy Disturbance Check cheat sheet](docs/images/cheat-sheet.png)](docs/cheat-sheet.pdf)

One page, condensed from the SOP of 3 September 2026 and covering the
interactive tool. Click it for the PDF at [`docs/cheat-sheet.pdf`](docs/cheat-sheet.pdf).
